...
species(
    label = "PDDJ2",
    structure = SMILES("[CH2]C(CCCCCCCCCC)C1C=CC=CC=1"))

species(
    label = "PDDJ3",
    structure = SMILES("[CH2]CC(CCCCCCCCC)C1C=CC=CC=1"))

species(
    label = "PDDJ4",
    structure = SMILES("[CH2]CCC(CCCCCCCC)C1C=CC=CC=1"))

species(
    label = "PDDJ5",
    structure = SMILES("[CH2]CCCC(CCCCCCC)C1C=CC=CC=1"))

species(
    label = "s2_5_6_ben_c9",
    structure = SMILES("CCCCCCCCCC1CCC2C=CC=CC=21"))

species(
    label = "s2_6_6_ben_c8",
    structure = SMILES("CCCCCCCCC1CCCC2C=CC=CC=21"))
...
simpleReactor(
    ...
    terminationTime = (12,"h"),
    terminationConversion = {
        "PDD": 0.8,
    },
    sensitivity='all',
    sensitivityThreshold=1e-6,
)
